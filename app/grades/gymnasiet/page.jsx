      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-8">
          <div className="flex flex-col items-center gap-2">
            ...
            <h1 className="text-3xl font-bold">Gymnasiet</h1>
          </div>
          ...
          <p className="text-gray-600 max-w-xl mx-auto mt-2">
            Utforska vårt omfattande bibliotek av lektioner för gymnasienivå! Här hittar du material inom olika ämnen
            som hjälper dig att fördjupa dina kunskaper. Använd filtret för att hitta specifika lektioner inom ditt
            intresseområde.
          </p>
